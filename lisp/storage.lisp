...
@const-start
(define eeprom-magic 20260915)
; 20260914 shares this layout minus the brake-generator tail at 380.
                        ...
                        (cond
                            ...
                            ((and (storage-image-valid b)
                                ...
                                (progn
                                    ...
                                    ; A 20260914 image has no tail: keep the
                                    ; defaults rather than reading zeros.
